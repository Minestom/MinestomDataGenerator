...
public final class ItemTagGenerator extends DataGeneratorCommon {
    private static final Logger LOGGER = LoggerFactory.getLogger(ItemTagGenerator.class);
    ...
    public JsonObject generate() {
        ...
        if (listedFiles != null) {
            ...
            for (int i = 0; i < children.size(); i++) {
                ...
                JsonObject itemTag;
                try {
                    itemTag = DataGen.GSON.fromJson(new JsonReader(new FileReader(file)), JsonObject.class);
