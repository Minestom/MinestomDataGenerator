...
public final class GameEventTagGenerator extends DataGeneratorCommon {
    ...
    public JsonObject generate() {
        ...
        if (listedFiles != null) {
            ...
            for (int i = 0; i < children.size(); i++) {
                ...
                try {
                    gameEventTag = DataGen.GSON.fromJson(new JsonReader(new FileReader(file)), JsonObject.class);
